...
from core.models import Profile, Movie, Video
...
# https://docs.djangoproject.com/en/4.1/ref/class-based-views/base/#django.views.generic.base.View.dispatch
...
class PlayMovie(View):
    def get(self, request, movie_id, *args, **kwargs):
        try:
            ...
            return redirect('coreprofile_list')